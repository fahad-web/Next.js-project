  ...
  return (
    <React.Fragment>
      ...
      <center>
          ...
          <p className='mt-6'>If you are not register! <Link href="./admin/admin_reg">Register</Link></p>
          <p className='mt-6 mb-6'>Already have a account <Link href="./admin/admin_log" className='text-green-500 ml-16-10'>Log in</Link></p>
          <Image 
              src="/fahad1.png" 
              alt="Photo" 
              height={250}
